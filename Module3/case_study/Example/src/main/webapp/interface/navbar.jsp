<nav class="navbar navbar-expand-lg bg-light sticky-lg-top">
    <div class="container-fluid" style="background-color: #046056; height: 70px">
        <a class="navbar-brand" href="/view/interface/home.jsp" style="color: white;margin-left: 100px">Home</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/facility" style="color: white">Facility</a>
                </li>
                <li class="nav-item">
