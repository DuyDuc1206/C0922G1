...
select mb.id,mb.ten_mb,mb.trang_thai,mb.dien_tich,mb.tang,mb.gia_tien,mb.ngay_bat_dau, mb.ngay_ket_thuc, lmb.ten_mat_bang from mat_bang as mb join loai_mat_bang as lmb where mb.ma_loai_mat_bang = lmb.ma_loai_mat_bang;